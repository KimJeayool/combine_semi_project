...
<link rel="stylesheet" type="text/css"
	href="/semipub/css/mainLayout.css">
...
<script>
	//날짜검색
	function searchList() {
		location.href = "salesList.jsp?startdate="
				+ document.salesfm.startdate.value + "&enddate="
				...
				<form name="salesfm">
					...
					<div id="tb">
						<div id="dt" align="right">
							<input type="button" value="전체" onclick="allList();"> <input
								type="date" value="<%=sdto.getStartdate()%>" name="startdate">
							<input type="date" value="<%=sdto.getEnddate()%>" name="enddate">&nbsp;<input
								type="button" value="검색" name="searchbt" onclick="searchList();">
						</div>
						<br>
						<table id="RTB">
							<tr>
						...
						<tfoot>
							<tr>
								<td>
									...
									if (userGroup != 0) {
									%> <a
									href="salesList.jsp?cp=<%=(userGroup - 1) * pageSize + pageSize%>">&lt;&lt;</a>
									<%
									}
									%> <%
